...
**Registre des livrables de présentation** — captures réelles de production, en local, zéro cloud.
...
*Livrables auto-générés — `demo/build-report.sh`. Les versions vidéo canoniques (master narré,
short 9:16, production live, montage maître) sont conservées hors dépôt public en raison de leur poids.*
